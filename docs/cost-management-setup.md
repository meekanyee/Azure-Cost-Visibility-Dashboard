...
I set up a view that shows spend split between
`rg-cost-dashboard-dev` and `rg-cost-dashboard-prod`. This
answers the most common question a small business has, which is
which environment is costing more this month.
